module.exports = [
...

    {
        ...
        img_URL: "",
        description: "Striking, scarlet-red tubular flowers attract hummingbirds and swallowtail butterflies",
        createdAt: new Date(),
        updatedAt: new Date()
    },
...

    {
        ...
        img_URL: "",
        description: "Long bloom period; shade-tolerant; visited by bumble bees and other pollinators; seeds provide food for birds",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        ...
        img_URL: "",
        description: "The shallow nectaries attract more insect diversity than some larger-flowered aster species; tolerant of partial shade",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        ...
        img_URL: "",
        description: "Goldenrods are frequented by beneficial solitary wasps, pollen-eating soldier beetles, bumble bees, and much more",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    //11-17 Region 2 (Mid-Atlantic)
    {
...

    {
        ...
        img_URL: "",
        description: "Host plant for monarchs (Danaus plexippus); nectar source for many bees; swamp and common milkweed are also recommended",
        createdAt: new Date(),
        updatedAt: new Date()
    },
...

    {
        ...
        img_URL: "",
        description: "A major honey producer and great as a shade-tolerant rain garden or wetland edge plant; may be hard to find in nurseries",
        createdAt: new Date(),
        updatedAt: new Date()
    },
...

    {
        ...
        img_URL: "",
        description: "Blazing stars (Liatris spp.) support bees as well as many butterflies including monarchs, swallowtails, skippers, and sulfurs",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        ...
        img_URL: "",
        description: "Does well in average to wet soil; flowering stalks may need support in gardens",
        createdAt: new Date(),
        updatedAt: new Date()
    },


    //33-41 Region 7 (Southern Plains)
    {
    ...
    {
        common_name: "Prairie spiderwort",
        scientific_name: "Tradescantia occidentalis",
        img_URL: "",
        description: "Drought tolerant; will grow in partial shade; deer-resistant; attracts bumble bees, honey bees, and beneficial flies",
        createdAt: new Date(),
        updatedAt: new Date()
    },
...

    {
        ...
        img_URL: "",
        description: "Foliage repellant to deer; attracts bees and beneficial flies, beetles, and wasps during its long bloom period",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        common_name: "Wholeleaf rosinweed",
        scientific_name: "Silphium integrifolium",
        img_URL: "",
        description: "Grows in a variety of soils; attracts bees and beneficial flies, and is a host plant for the silphium moth (Papaipema silphii)",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        common_name: "Azure blue sage",
        scientific_name: "Salvia azurea",
        img_URL: "",
        description: "Grows in a variety of soils; fragrant foliage; attracts long-tongued bees; a host plant for the hermit sphinx moth (Lintneria eremitus)",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    //42-46 Region 8 (Northern Plains)
    {
...

    {
        ...
        img_URL: "",
        description: "Fragrant foliage; reseeds and colonizes readily; very attractive to bees (including honey bees), butterflies, moths and beneficial flies",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        ...
        img_URL: "",
        description: "Grows in many soils; asters (Symphyotrichum spp.) are visited by butterflies, bees, and other beneficial insects",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    //47-53 Region 9 (Mountain)
    {
    ...
    {
        common_name: "Foothill penstemon",
        scientific_name: "Penstemon heterophyllus",
        img_URL: "",
        description: "Iridescent violet flowers attract bees, butterflies, and hummingbirds; requires good drainage; heat and drought tolerant",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    {
        ...
        scientific_name: "Epilobium canum",
        img_URL: "",
        description: "Abundant scarlet-colored flowers; critical late-season nectar source for hummingbirds and bees",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    //67-71 Region 12 (Maritime Northwest)
    {
        common_name: "Bigleaf lupine",
        scientific_name: "Lupinus polyphyllus",
        img_URL: "",
        description: "Visited extensively by bumble bees and hummingbirds; prefers moist soils; a host plant for various blue (Icaricia spp.) butterflies",
        createdAt: new Date(),
        updatedAt: new Date()
    },
    {
    ...
    {
        common_name: "Puget Sound gumweed",
        scientific_name: "Grindelia integrifolia",
        img_URL: "",
        description: "Long-lasting flowers; blooms year-round in warm weather; tolerates poor soils; highly attractive to green metallic sweat bees (cover)",
        createdAt: new Date(),
        updatedAt: new Date()
    },

    //72-74 Region 13 (Hawaii)
    {
